...
/**
 * OPTIONS FRAMEWORK
 * This framework was adapted from the Options Panel Theme designed by Devin Price.
 * In the interest of full disclosure, we've made basically zero functional changes to the framework.
 * Thanks Devin. This is handy.
 * 
...
$options[] = array(
		'name' => __('Header Color', 'options_framework_theme'),
		'desc' => __('Color of the header bar', 'options_framework_theme'),
		'id' => 'option_header',
		'std' => '#1d618e',
		'type' => 'color' );

$options[] = array(
		'name' => __('Header Link', 'options_framework_theme'),
		'desc' => __('Color of the links in the header bar', 'options_framework_theme'),
		'id' => 'option_header_links',
		'std' => '#f0f0f0',
		'type' => 'color' );

$options[] = array(
		'name' => __('Text Color', 'options_framework_theme'),
		'desc' => __('Default Text Color', 'options_framework_theme'),
...
$options[] = array(
		...
		'desc' => __('Default Link Color', 'options_framework_theme'),
		'id' => 'option_link_color',
		'std' => '#1d618e',
		'type' => 'color' );

$options[] = array(
		'name' => __('Active Link Color', 'options_framework_theme'),
		'desc' => __('Color of hovered or active links', 'options_framework_theme'),
		'id' => 'option_active_link_color',
		'std' => '#b14140',
		'type' => 'color' );
...
$theme_fonts = array(
		'Lato' => __('Lato (Default)', 'options_framework_theme'),
		...
		'Roboto' => __('Roboto', 'options_framework_theme'),
		'Roboto Condensed' => __('Roboto Condensed', 'options_framework_theme'),
...
$options[] = array(
		'name' => __('Theme Font', 'options_framework_theme'),
		'desc' => __('Select the font for this theme.', 'options_framework_theme'),
		'id' => 'option_theme_font',
		'std' => 'Lato',
		'type' => 'select',
...
$options[] = array(
		'name' => __('Custom CSS/Javascript', 'options_framework_theme'),
		'type' => 'heading');
		
		$options[] = array(
			'name' => __('CSS', 'options_framework_theme'),
			'desc' => __('Add your custom css here', 'options_framework_theme'),
			'id' => 'option_custom_css',
			'std' => '',
			'type' => 'textarea');
		
		$options[] = array(
			'name' => __('Javascript', 'options_framework_theme'),
			'desc' => __('Add your custom javascript here', 'options_framework_theme'),
			'id' => 'option_custom_javascript',
			'std' => '',
			'type' => 'textarea');
...
$options[] = array(
	...
	$options[] = array(
		...
		'desc' => __('Full link to your Facebook Page.', 'options_framework_theme'),
		'id' => 'option_social_facebook',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('Twitter', 'options_framework_theme'),
		'desc' => __('Full link to your Twitter Page.', 'options_framework_theme'),
		'id' => 'option_social_twitter',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('Pinterest', 'options_framework_theme'),
		'desc' => __('Full link to your Pinterest Page.', 'options_framework_theme'),
		'id' => 'option_social_pinterest',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('YouTube', 'options_framework_theme'),
		'desc' => __('Full link to your YouTube Page.', 'options_framework_theme'),
		'id' => 'option_social_youtube',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('Google+', 'options_framework_theme'),
		'desc' => __('Full link to your Google+ Page.', 'options_framework_theme'),
		'id' => 'option_social_google',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('Flickr', 'options_framework_theme'),
		'desc' => __('Full link to your Flickr Page.', 'options_framework_theme'),
		'id' => 'option_social_flickr',
		'std' => '',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('Instagram', 'options_framework_theme'),
		'desc' => __('Full link to your Instagram Page.', 'options_framework_theme'),
		'id' => 'option_social_instagram',
		'std' => '',
		'type' => 'text');
